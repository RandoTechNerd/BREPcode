...
module.exports = { main };`,
  },
  {
    ...
    works: [
      ...
      "1D lines: Line · Polyline · FilletPolyline · PolarLine · Spline · Bezier · CenterArc · EllipticalCenterArc · ThreePointArc · RadiusArc · SagittaArc · JernArc — chain with + or Wire([e1, e2, …]), close with make_face(...), then extrude",
      "fillet(sketch.vertices(), radius=4) rounds a sketch's corners · GridLocations(25, 15, 2, 2) * Circle(2.5) and PolarLocations(r, n) * shape place copies (the algebra form of the for-loop) · show()/export lines are ignored",
